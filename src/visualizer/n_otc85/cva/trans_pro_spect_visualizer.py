...
class TransProSpectVisualizer(ConstInitializer):
    ...
    def plot_trans_pro_spect(self, ):
        ...
        fig = plt.figure(figsize=(self.visual_count * 5.5 + 1, 5 * 2))
        ...
        plt.savefig(f"{self.n_otc85_cva_trans_pro_spect_graph_path}.png", format='png', dpi=1000, bbox_inches='tight')
        plt.savefig(f"{self.n_otc85_cva_trans_pro_spect_graph_path}.pdf", format='pdf', bbox_inches='tight')
        plt.show()